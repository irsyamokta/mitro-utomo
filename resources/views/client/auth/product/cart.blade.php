...
@section('content')
    ...
    <section class="flex flex-col h-[100vh] overflow-hidden mx-4 lg:mx-14 mt-28">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                ...
                <tbody>
                    <tr class="bg-white border-b">
                        ...
                        <td class="p-4 w-2">
                            <img src="{{ asset('assets/img/img-product-1.png') }}"
                                class="md:w-32" alt="Product">
                        </td>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center mt-5 w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow-md">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                    <tbody>
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4 font-semibold text-lg text-gray-900">
                                Pilih Semua
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-5 md:space-x-5">
                <p class="text-start text-base text-gray-500 sm:text-lg">Total (0 Produk): <span class="font-semibold text-lg md:text-3xl text-accent">Rp 300.000</span></p>
                <a href="/checkout" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-accent rounded-lg hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300">
                    <button>
                        Checkout
                    </button>
                </a>
