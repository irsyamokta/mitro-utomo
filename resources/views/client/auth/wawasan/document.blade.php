<section class="flex flex-col bg-cover bg-center items-center justify-start lg:px-12">
    <div class="px-6 w-full max-w-screen-xl py-5 text-center">
        <h1 class="text-2xl font-semibold tracking-wide text-secondary md:text-3xl lg:text-4xl">Dokumen Wawasan</h1>
                    ...
                    @else
                        @foreach ($document as $row)
                            <tr class="bg-white border-b">
                                <th scope="row" class="px-3 py-4 flex justify-center">
                                    <a href="{{ $row->link }}" target="_blank">
                                        <svg width="100" height="100" version="1.1" id="_x35_"
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                <g>
                                                    ...
                                                    <polygon style="fill:#771B1B;"
                                                        points="475.435,117.836 357.599,117.836 357.599,0 "></polygon>
                                                    <g>
